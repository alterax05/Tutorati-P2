...
\textbf{Vedi soluzioni a fine documento.}
\end{enumerate}
...
\newpage
 ...
 % ═══════════════════════════════════════════════════════════════════════════════
%  TEST 9  — VERO / FALSO CON SOLUZIONI
% ═══════════════════════════════════════════════════════════════════════════════
\section*{Test 9 Soluzioni}
...
\rule{0pt}{1.4em}\textbf{A} & \textbf{B} & \textbf{C} & \textbf{D} & \textbf{E} & \textbf{F} & \textbf{G} & \textbf{H} \\[2pt]
\hline
\textbf{V} & \textbf{F} & \textbf{V} & \textbf{F} & \textbf{V} & \textbf{F} & \textbf{F} & \textbf{F} \\[8pt]
\hline
\end{tabular}
